# Captain Nova Analysis Examples

## 0. Complete Analysis
**Endpoint**: `POST <api_base_url>/api/captain/complete-analysis`
...
**Endpoint**: `POST <api_base_url>/api/captain/specialists/financial-meaning`
...
**Endpoint**: `POST <api_base_url>/api/captain/specialists/subscriptions`
...
**Endpoint**: `POST <api_base_url>/api/captain/specialists/budget-overruns`
...
**Endpoint**: `POST <api_base_url>/api/captain/specialists/upcoming-bills`
...
**Endpoint**: ``POST <api_base_url>/api/captain/specialists/debt-spirals`
...
**Endpoint**: `POST <api_base_url>/api/captain/specialists/missed-rewards`
...
**Endpoint**: `POST <api_base_url>/api/captain/specialists/fraud-detection`
